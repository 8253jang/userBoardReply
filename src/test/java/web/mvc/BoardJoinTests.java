...
public class BoardJoinTests {
    ...
    @Test
    void join1() {
        Pageable pageable = PageRequest.of(0,2 , Sort.Direction.ASC , "bno");
        //Pageable pageable = PageRequest.of(0,5 , Direction.ASC , "subject");
    ...
    @Test
    void join2() {
        Pageable pageable = PageRequest.of(1,2 , Sort.Direction.DESC , "bno");
